...
3. **Coverage gaps:** any records where key fields were missing or empty, and why
   if known
4. **Screenshots:** attach or reference the screenshots from Phase 1 — include any
   that surfaced issues or interesting observations
5. **Output location:** where the files were saved
